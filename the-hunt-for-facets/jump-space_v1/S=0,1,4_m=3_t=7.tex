...
\end{tikzpicture}
\end{minipage}
\par\smallskip Jumps in $E(S)$: $J=\{1,3\}$
\par $b_{01} + b_{04} + b_{14} \le d_m(|S|)=d_{3}(3)=2$
\par $y_{1} + 2 y_{3} \le 2$
\end{center}
...
\par $y=\left(\textcolor{red}{1},0,\textcolor{red}{0}\right)$
...
\par $L=\{2\}$
\par $y=\left(\textcolor{red}{0},1,\textcolor{red}{0}\right)$
\par $|E(L)\cap E(S)|=0\;\;\textcolor{red}{\boldsymbol{\times}}$
\end{minipage}\hfill\begin{minipage}[t]{0.31\textwidth}
\centering
\begin{tikzpicture}[
  thick,  vertex/.style={circle,draw,inner sep=1.2pt,font=\scriptsize},  svertex/.style={circle,draw=red,text=red,inner sep=1.2pt,font=\scriptsize},  baseline=(current bounding box.north)
...
\par $y=\left(\textcolor{red}{0},0,\textcolor{red}{1}\right)$
...
\par $L=\{\textcolor{red}{1},2\}$
\par $y=\left(\textcolor{red}{1},1,\textcolor{red}{0}\right)$
\par $|E(L)\cap E(S)|=1\;\;\textcolor{red}{\boldsymbol{\times}}$
\end{minipage}\hfill\begin{minipage}[t]{0.31\textwidth}
\centering
\begin{tikzpicture}[
...
\par $y=\left(\textcolor{red}{1},0,\textcolor{red}{1}\right)$
...
\par $L=\{2,\textcolor{red}{3}\}$
\par $y=\left(\textcolor{red}{0},1,\textcolor{red}{1}\right)$
\par $|E(L)\cap E(S)|=2\;\;\textcolor{green!60!black}{\checkmark}$
\end{minipage}
\par\medskip
\noindent
...
\par $y=\left(\textcolor{red}{1},1,\textcolor{red}{1}\right)$
\par $|E(L)\cap E(S)|=3\;\;\textcolor{red}{\boldsymbol{\times}}$
\end{minipage}
\par\medskip
...
\par $N=2$
\par $I=\{3,6\}$\quad$Y=\begin{bmatrix}0 & 0 \\ 0 & 1 \\ 1 & 1\end{bmatrix}$
\par $Y^{+}=\begin{bmatrix}0 & 0 \\ 0 & 1 \\ 1 & 1 \\ 1 & 1\end{bmatrix}$\quad$\operatorname{rank}(Y^{+})=2$
\end{document}
